...
// Quill Editors Global Variables
let chapterDescriptionQuill;
let videoDescriptionQuill;

// Initialize Quill Rich Text Editors
function initializeQuillEditors() {
    // Chapter Description Editor
    if (document.getElementById('chapterDescriptionEditor')) {
        chapterDescriptionQuill = new Quill('#chapterDescriptionEditor', {
            theme: 'snow',
            placeholder: 'Chapter description जो students को समझाएगी कि इस chapter में क्या सीखेंगे...',
            modules: {
                toolbar: [
                    [{ 'header': [1, 2, 3, false] }],
    ...
    if (document.getElementById('videoDescriptionEditor')) {
        videoDescriptionQuill = new Quill('#videoDescriptionEditor', {
            theme: 'snow',
            placeholder: 'Video का description और इसमें क्या सिखाया गया है...',
            modules: {
                toolbar: [
                    ['bold', 'italic', 'underline'],
                    [{ 'list': 'ordered'}, { 'list': 'bullet' }],
...
async function saveChapter() {
    ...
    try {
        ...
        chapterDescriptionQuill.setContents([]);
...
async function saveVideo() {
    ...
    const videoId = title.toLowerCase().replace(/[^a-z0-9]+/g, '-').replace(/(^-|-$)/g, '');
    ...
    try {
        // Save to Firebase - Updated structure to match user's data
        await window.firebaseUtils.saveData(`videoLibrary/${videoId}`, videoData);
        
        showAlert('✅ Video saved successfully!', 'success');
        
        // Clear form
        document.getElementById('videoTitle').value = '';
        videoDescriptionQuill.setContents([]);
...
async function loadSampleVideos() {
    ...
    const sampleVideos = [
        {
            ...
            description: "<p>Learn basic greetings in English with pronunciation. इस video में आप सीखेंगे:</p><ul><li>Hello, Hi, Good Morning</li><li>How to respond to greetings</li><li>Formal vs Informal greetings</li></ul>",
        ...
        },
        {
            ...
            description: "<p>Fundamental grammar concepts for beginners</p><ul><li>Subject-Verb-Object structure</li><li>Articles: a, an, the</li><li>Simple Present Tense</li></ul>",
            category: "grammar",
            level: "Beginner",
            duration: 12,
        ...
        },
        {
            ...
            description: "<p>Improve your English pronunciation with expert tips</p><ul><li>Vowel sounds practice</li><li>Silent letters</li><li>Word stress patterns</li></ul>",
        ...
        },
        {
            ...
            description: "<p>Build your vocabulary with commonly used English words</p><ul><li>Daily routine words</li><li>Family members</li><li>Food and drinks</li></ul>",
            category: "vocabulary",
            level: "Beginner",
            duration: 10,
    ...
    try {
        // Save each video individually with the new structure
        for (const video of sampleVideos) {
            await window.firebaseUtils.saveData(`videoLibrary/${video.id}`, {
                title: video.title,
