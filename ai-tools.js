...
Make it engaging and appropriate for daily practice.`;
        ...
        const systemPrompt = "You are an expert English teacher creating personalized daily practice sessions. Create engaging, practical exercises that students can complete independently.";
        
        const response = await aiToolsManager.makeAPICall('practice', prompt, { systemPrompt });
        
        output.innerHTML = `
            <h4>📅 Your Daily Practice Session</h4>
            <div class="practice-content">${response}</div>
            <div style="margin-top: 1rem; text-align: center;">
                <button class="ai-btn secondary" onclick="generateDailyPractice()">🔄 Generate New Practice</button>
